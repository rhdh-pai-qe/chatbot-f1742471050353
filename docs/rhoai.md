...
3) Access the `workbench` named `chatbot-f1742471050353-notebook`.
...
5) In the terminal, run `cd chatbot-f1742471050353` to navigate to your sample app's directory.
